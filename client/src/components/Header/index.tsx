                ...
                <nav className="bg-white text-dark border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div className="flex items-center lg:order-2">
                            <Link to="/login" className="bg-stone-300 text-dark dark:text-white hover:bg-orange-300 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-orange-300 focus:outline-none dark:focus:ring-gray-800">Войти</Link>
                            <Link to="/registration" className="text-dark bg-stone-200 hover:bg-stone-400 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Зарегистрироваться</Link>
