    ...
    <div className={styles.root}>
      <Container maxWidth="lg">
        ...
        <div className="grid grid-cols-1 gap-4 place-items-center mt-48">
          <p className={"self-end"} style={{ display: "block" }}>
            <span
              className={"text-3xl font-bold"}
              style={{ fontFamily: "Montserrat" }}
            >
              В твоем городе возникла проблема?
            </span>
          </p>
          <p className={"self-end"} style={{ display: "block" }}>
            <span className={""} style={{ fontFamily: "Montserrat" }}>
              Опиши проблему или голосуй за другие проблемы
            </span>
          </p>
          <Button
            className={"self-end w-96 mt-2"}
            style={{
              backgroundColor: "orange",
              borderColor: "black",
              fontFamily: "Montserrat",
            ...
            variant="contained"
          >
            Рассказать о городской проблеме
          </Button>
        </div>
      </Container>
    </div>
